...
const hasFriendInReason = computed(() => /\bfriends?\b/i.test(formData.value.reason))
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-1">
            ...
            ></textarea>
            <div v-if="hasFriendInReason" class="text-success mt-1">
              Great to have a friend
            </div>
          </div>

          <!-- Suburb (ONE-WAY using v-bind:value) -->
          <div class="mb-3">
